...
function handleWasmError(e, cmd, onError) {
    const getErrorMessage = () => {
        if ((0, panic_1.isWasmPanic)(e)) {
            const { message } = (0, panic_1.getWasmError)(e);
    ...
    if (onError) {
        onError("prisma-schema-wasm errored. To get a more detailed output please see Prisma Language Server output. You can do this by going to View, then Output from the toolbar, and then select 'Prisma Language Server' in the drop-down menu.");
    }
}
